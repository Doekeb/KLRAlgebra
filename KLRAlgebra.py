...
#	def gen(self, i=0):
	...
	def product(self, left, right):
		...
		"""
		if (left, right) in self._my_products:
			return self._my_products[(left, right)]
		sum = self.zero()
		...
		self._my_products[(left, right)] = sum
		return sum
...
# 		return sum
		...
		sum = 0
		for k in rw[::-1]:
#			print -alpha[perm[k-1]],alpha[perm[k]], self.symmetric_form(-alpha[perm[k-1]],alpha[perm[k]])
